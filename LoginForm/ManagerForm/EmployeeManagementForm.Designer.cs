namespace LoginForm.ManagerForm
{
    partial class EmployeeManagementForm
    {
		...
		private void InitializeComponent()
		{
			...
			ribbon.Items.AddRange(new DevExpress.XtraBars.BarItem[] { ribbon.ExpandCollapseItem, barButtonItem1, barButtonItem2, barButtonItem3, barButtonItem4, barButtonItem5, barButtonItem6 });
